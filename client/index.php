...
<div class="boxcenter">
    <div class="row mb header">
        ...
        <div class="account-user">
            <a href="./view/auth/login.php" class="button"><i class="fas fa-sign-in-alt"></i> Đăng nhập</a>
            <a href="./view/auth/register.php" class="button"><i class="fas fa-user-plus"></i> Đăng ký</a>
        </div>
...
<div>
    Mời bạn truy cập trang quản trị. <a href="<?= BASE_URL_ADMIN . '?act=list-product' ?>">
