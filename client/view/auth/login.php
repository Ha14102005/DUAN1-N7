...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->num_rows > 0) {
        ...
        if (password_verify($password, $hashed_password)) {
            ...
            if ($role === 'admin') {
                echo "<div class='alert alert-success'>Đăng nhập thành công! Chào mừng người dùng.</div>";
                header("Location: http://localhost/da1/DA1-N7/admin/"); // Chuyển đến trang admin
             } else {
                 echo "<div class='alert alert-success'>Đăng nhập thành công! Chào mừng người dùng.</div>";
                 header("Location: http://localhost/da1/DA1-N7/client/index.php"); // Chuyển đến trang người dùng
            }
            exit;
        } else {
